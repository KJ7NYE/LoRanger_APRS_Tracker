...
// LoRanger fork: meshtastic's variant.h defines PIN_LED1 but not LED_BUILTIN,
// which Adafruit_LittleFS/flash_cache.c references for flash-activity blink.
// Alias to PIN_LED1 here so the BSP libs link cleanly.
